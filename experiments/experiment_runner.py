...
class ExperimentRunner:
    ...
    def __init__(self, config_path: str = "config/settings.yaml", output_dir: str = "experiments/results"):
        """
    ...
    def compare_with_baseline(self, baseline_results: Dict[str, Any], cmvk_results: Dict[str, Any]) -> None:
        """
