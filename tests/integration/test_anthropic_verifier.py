...
"""
    ...
    def test_verify_with_mocked_api(self, mock_anthropic_class):
        ...
        mock_response.content = [MagicMock(text="VERDICT: PASS\nCONFIDENCE: 0.9\nREASONING: Good code")]
...
class TestAnthropicVerifierIntegration:
    ...
    def test_real_verification(self):
        ...
        assert isinstance(result, VerificationResult)
        assert result.outcome in [VerificationOutcome.PASS, VerificationOutcome.FAIL, VerificationOutcome.UNCERTAIN]
