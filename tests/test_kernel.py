...
class TestMockModelInterface(unittest.TestCase):
    ...
    def test_mock_gemini_response(self):
        ...
        self.assertTrue(
            "CRITICAL" in response.content or 
            "HIGH" in response.content or
            "issues" in response.content.lower()
        )
...
class TestVerificationKernel(unittest.TestCase):
    ...
    def test_blind_spot_calculation(self):
        ...
        self.assertLess(
            analysis.combined_error_prob,
            analysis.single_model_error_prob
        )
